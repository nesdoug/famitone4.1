// text2vol4.cpp  version 4.0: Defines the entry point for the console application.
...
int output_header(char *songname, int song)
{
	...
	fprintf(outfile, ";this file for FamiTone4.1 library generated by text2vol4 tool\n");
